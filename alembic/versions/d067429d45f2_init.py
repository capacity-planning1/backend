...
def upgrade() -> None:
    ...
    op.create_index(
        'ix_refresh_session_expires_at', 'refresh_session', ['expires_at'], unique=False
    )
    op.create_index('ix_refresh_session_jti', 'refresh_session', ['jti'], unique=False)
    op.create_index(
        op.f('ix_refresh_session_student_id'),
        'refresh_session',
        ['student_id'],
        unique=False,
    )
    ...
    op.create_table(
        ...
        sa.Column(
            'status',
            sa.Enum(
                'OPEN', 'IN_PROGRESS', 'REVIEW', 'TESTING', 'DONE', name='statustype'
            ),
            nullable=False,
        ),
        sa.Column(
    ...
    op.create_table(
        ...
        sa.Column(
            'slot_type',
            sa.Enum('PAIR', 'CREDIT', 'EXAM', 'PERSONAL', name='slottype'),
            nullable=False,
        ),
    ...
    op.create_table(
        ...
        sa.Column(
            'status',
            sa.Enum('PENDING', 'APPROVED', 'REJECTED', name='taskchangerequeststatus'),
            nullable=False,
        ),
